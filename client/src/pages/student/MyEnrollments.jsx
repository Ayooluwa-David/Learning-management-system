                    ...
                    {enrolledCourses.map(
                      (course, index) => (
                       <tr key={index} className='border-b border-gray-500/20'>
                           <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center spacing-x-3'>
                               <img src={course.courseThumbnail} alt="" className='w-14 sm:w-24 md:w-28 md:px-3'/>

                               <div className='flex-1'>
                                   <p className='mb-1 max-sm:text-sm px-4'>{course.courseTitle}</p>
