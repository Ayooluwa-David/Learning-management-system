...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateNoOfLetures, calculateCourseDuration, calculateChapterTime, currency} = useContext(AppContext)
                          ...
                          <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0, 200)}}></p>
                                   ...
                                   {/* reviews and ratings */}
                                       ...
                                       <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                                            ...
                                            <div className='flex'>
                                                 {[...Array(5)].map((_, i)=>(<img 
                                                    key= {i} src={i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank}
                                       ...
                                       <p>Course by <span className='text-blue-600 underline'>Winners School</span></p>
                                    ...
                                    <div className='py-20 text-sm md:text-default'>
                                          <h3 className='text-xl font-semibold text-gray-800'>Course Description</h3>
                                           <p className='pt-3 rich-text' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0, 200)}}></p>
                                    </div>
                     </div>
                            ...
                            <div className='flex gap-3 items-center pt-2'>
                              ...
                              <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
                                  ...
                                  <div className='flex items-center gap-1'>
                                    ...
                                    <p>{calculateNoOfLetures(courseData)} lessons</p>

                                  </div>

                              </div>
                                 <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-700 text-white font-medium'> {
